...
namespace aa {
	...
	inline void cshift_right(const I &b, const I &b_An_S1, const O &b2, const O &b2_A1, const size_t n_S1_MS) {
	...
	template<std::contiguous_iterator I, trivial_output_iterator_for<I> O>
	inline void cshift_right(const I &b, const O &b2, const size_t n_S1) {
	...
	inline void cshift_right(I &&i, O &&o) {
	...
	template<std::contiguous_iterator I, trivial_output_iterator_for<I> O>
	inline void cshift_right(const I &b, const I &b_An_Ss, const O &b2, const O &b2_As, const size_t n_Ss_MS, const size_t s_MS) {
		std::memcpy(std::to_address(b2_As), std::to_address(b), n_Ss_MS);
		std::memcpy(std::to_address(b2), std::to_address(b_An_Ss), s_MS);
	}

	template<std::contiguous_iterator I, trivial_output_iterator_for<I> O>
	inline void cshift_right(const I &b, const O &b2, const size_t n_Ss, const size_t s) {
		cshift_right(b, b + n_Ss, b2, b2 + s, size_of<std::iter_value_t<I>>(n_Ss), size_of<std::iter_value_t<I>>(s));
	}

	template<sized_contiguous_range I, trivial_output_range_for<I> O>
	inline void cshift_right(I &&i, O &&o, const size_t s) {
