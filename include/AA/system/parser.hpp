...
namespace aa {
	...
	[[gnu::always_inline]] AA_CONSTEXPR void parse(TUPLE &t, FILE &&file, EVAL &&eval = {}) {
	...
	[[gnu::always_inline]] AA_CONSTEXPR std::remove_const_t<TUPLE> parse(FILE &&file, EVAL &&eval = {}) {
